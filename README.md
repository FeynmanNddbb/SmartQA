...
🤖 **AI 能力增强**
- [ ] 接入大语言模型 API（ChatGPT/Claude/通义千问等）
- [ ] 智能联网知识拓展 - 当本地题库无法匹配时自动调用 AI 进行实时回答
- [ ] 多源知识融合 - 结合本地题库 + 在线 AI，提供更comprehensive的答案
- [ ] 对话式问答 - 支持多轮对话交互
- [ ] 知识点讲解 - AI 生成更深入的解析说明
...
**欢迎提 Issue 或 PR 参与项目开发！** 如有建议和想法，欢迎在 GitHub Issues 中讨论。
